...
// Estima Engine is the site's landing page: it lives at "/" and the former
// /engine route 308-redirects here (see next.config.js).
export default function HomePage() {
  const { t } = useI18n()

  const metrics = [
    { value: "400+", label: t("engine.metric1") },
    { value: "8", label: t("engine.metric2") },
    { value: "72", label: t("engine.metric3") },
