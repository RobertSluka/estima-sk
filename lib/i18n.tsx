...
const dict: Record<Lang, Record<string, string>> = {
  sk: {
    ...
    "engine.metric4Value": "CZ + SK",
    "engine.metric4": "Pokryté trhy",
    ...
    "analyses.header.viewListing": "Zobraziť inzerát",
    "analyses.header.sourceAd": "Pôvodný inzerát",
    "analyses.header.morePhotos": "+{n} fotiek",
    ...
    "analyses.pdf.section.buyVsRent": "Kúpa vs. nájom a investovanie",
    "analyses.pdf.section.location": "Lokalita a vybavenosť",
    "analyses.bvr.title": "Kúpa vs. nájom a investovanie",
    "analyses.bvr.subtitle":
      "Modelová projekcia čistého majetku na 30 rokov — rovnaká sekcia je súčasťou PDF reportu.",
    "analyses.bvr.localMarket": "miestny trh",
    "analyses.bvr.assumptions":
      "Predpoklady: nájom {rent}/mes. (medián nájomných inzerátov, {district}) · hypotéka 4 % / 80 % LTV / 30 rokov · rast ceny {growth} % p.a. (NBS, {region}, priemer 2002–2025) · výnos investícií 5 % · inflácia 2,5 %. Modelový prepočet, nejde o finančné poradenstvo.",
    ...
    "profile.subtitle": "Spravujte svoje údaje, heslo a predplatné.",
    "profile.signInPrompt": "Ak chcete zobraziť profil, prihláste sa.",
    "profile.planBasic": "Zadarmo",
    "profile.methodPassword": "E-mail a heslo",
    "profile.methodGoogle": "Prepojené s Google",
    "profile.manageBilling": "Spravovať predplatné",
    "profile.upgrade": "Prejsť na Pro",
    "profile.adminReadOnly": "Administrátorský účet sa upravuje cez konfiguráciu servera.",
    "profile.nameSection": "Zobrazované meno",
    "profile.saveName": "Uložiť",
    "profile.passwordSection": "Zmena hesla",
    "profile.passwordHint": "Zadajte svoje aktuálne heslo a nové heslo (min. 8 znakov).",
    "profile.setPasswordSection": "Nastaviť heslo",
    "profile.setPasswordHint": "Nastavte si heslo, aby ste sa mohli prihlásiť aj e-mailom.",
    "profile.currentPassword": "Aktuálne heslo",
    "profile.newPassword": "Nové heslo",
    "profile.changePassword": "Zmeniť heslo",
    "profile.setPassword": "Nastaviť heslo",
    "profile.saved": "Zmeny boli uložené.",
    "profile.passwordSaved": "Heslo bolo zmenené.",
    "profile.saveError": "Uloženie zlyhalo. Skúste to znova.",
    "profile.wrongPassword": "Aktuálne heslo je nesprávne.",
    "profile.weakPassword": "Heslo musí mať aspoň 8 znakov.",
    "profile.nameRequired": "Zadajte meno.",
    ...
    "listings.price": "Cena (€)",
    "listings.priceMonthly": "Cena (€/mesiac)",
    "listings.priceChooseDeal": "Cenu filtrujte po výbere Predaj alebo Prenájom.",
    ...
    // property detail
    "property.back": "Späť na inzeráty",
    "property.forSale": "Na predaj",
    "property.forRent": "Na prenájom",
    "property.listed": "Pridané",
    "property.onPortal": "Sledované",
    "property.day": "{n} deň",
    "property.days": "{n} dní",
    "property.marketPosition": "Pozícia na trhu",
    "property.comparedTo": "V porovnaní s podobnými inzerátmi v lokalite {area}",
    "property.greatPrice": "Skvelá cena",
    "property.marketAverage": "Priemer trhu",
    "property.premium": "Prémiová",
    "property.save": "Uložiť",
    "property.saved": "Uložené",
    "property.share": "Zdieľať",
    "property.copied": "Odkaz skopírovaný",
    "property.exportReport": "Exportovať PDF report",
    "property.reportGenerating": "Generujem…",
    "property.reportError": "Report nie je dostupný — skúste znova",
    "property.morePhotos": "Viac fotiek v pôvodnom inzeráte",
    "property.pricePerSqm": "Cena za m²",
    "property.type": "Typ",
    "property.layout": "Dispozícia",
    "property.usableArea": "Úžitková plocha",
    "property.landArea": "Plocha pozemku",
    "property.firstSeen": "Prvý výskyt",
    "property.status": "Stav",
    "property.active": "Aktívny",
    "property.inactive": "Neaktívny",
    "property.location": "Lokalita",
    "property.address": "Adresa",
    "property.latitude": "Zemepisná šírka",
    "property.longitude": "Zemepisná dĺžka",
    "property.openInMaps": "Otvoriť v mapách",
    "property.expandMap": "Zväčšiť mapu",
    "property.nearbyHint": "Rozbaľte mapu a preskúmajte obchody, školy, dopravu a ďalšie v okolí",
    "property.exploreNearby": "Preskúmať okolie",
    "property.amenities": "Občianska vybavenosť",
    "property.groceries": "Potraviny",
    "property.schools": "Školy a škôlky",
    "property.transit": "MHD a doprava",
    "property.restaurants": "Reštaurácie",
    "property.health": "Lekári, lekárne",
    "property.leisure": "Voľný čas",
    "property.mapView": "Mapa",
    "property.satellite": "Satelit",
    "property.loadingPlaces": "Hľadám miesta v okolí…",
    "property.placesError": "Okolité miesta sa nepodarilo načítať.",
    "property.noPlaces": "Do 1 km sa nič nenašlo.",
    "property.retry": "Skúsiť znova",
    "property.closeMap": "Zavrieť mapu",
    // Generic labels for unnamed OSM POIs, keyed by the tag value the map's
    // Overpass query can return (PropertyMap.tsx stores it as `Poi.type`).
    "poi.supermarket": "Supermarket",
    "poi.convenience": "Potraviny",
    "poi.greengrocer": "Ovocie a zelenina",
    "poi.restaurant": "Reštaurácia",
    "poi.cafe": "Kaviareň",
    "poi.fast_food": "Rýchle občerstvenie",
    "poi.bar": "Bar",
    "poi.pub": "Krčma",
    "poi.food_court": "Food court",
    "poi.school": "Škola",
    "poi.kindergarten": "Škôlka",
    "poi.university": "Univerzita",
    "poi.college": "Stredná škola",
    "poi.pharmacy": "Lekáreň",
    "poi.doctors": "Ambulancia",
    "poi.clinic": "Poliklinika",
    "poi.hospital": "Nemocnica",
    "poi.dentist": "Zubná ambulancia",
    "poi.cinema": "Kino",
    "poi.theatre": "Divadlo",
    "poi.park": "Park",
    "poi.fitness_centre": "Fitnescentrum",
    "poi.sports_centre": "Športové centrum",
    "poi.playground": "Detské ihrisko",
    "poi.pitch": "Ihrisko",
    "poi.swimming_pool": "Bazén",
    "poi.garden": "Záhrada",
    "poi.bus_stop": "Autobusová zastávka",
    "poi.tram_stop": "Zastávka električky",
    "poi.station": "Stanica",
    "poi.subway_entrance": "Vstup do metra",
    "poi.halt": "Železničná zastávka",
    "poi.stop": "Zastávka",
    "property.interested": "Máte záujem o túto nehnuteľnosť?",
    "property.inquirySub": "Pošlite správu a prepojíme vás s inzerátom.",
    "property.yourName": "Vaše meno",
    "property.emailAddress": "E-mailová adresa",
    "property.phoneNumber": "Telefónne číslo",
    "property.messagePlaceholder":
      "Mám záujem o túto nehnuteľnosť. Prosím, kontaktujte ma s ďalšími podrobnosťami.",
    "property.sendInquiry": "Odoslať dopyt",
    "property.dataSafe": "Vaše údaje sú v bezpečí a nebudú zdieľané.",
    "property.inquirySent": "Dopyt odoslaný",
    "property.inquirySentSub": "Ďakujeme — čoskoro sa vám ozveme.",
    "property.viewOriginal": "Zobraziť pôvodný inzerát",
    "property.valuationTitle": "Chcete trhovú cenu?",
    "property.valuationSub":
      "Nechajte túto nehnuteľnosť prejsť cez Estima Engine a získajte okamžitý odhad.",
    "property.runValuation": "Spustiť odhad",
    "property.notFound": "Nehnuteľnosť sa nenašla",
    "property.notFoundSub": "Tento inzerát mohol byť odstránený alebo sa už nesleduje.",
    ...
    "buyRent.mode.occupier": "Bývať v nej",
    "buyRent.mode.landlord": "Prenajímať ju",
    "buyRent.monthlyRentIncome": "Mesačný nájom (príjem)",
    "buyRent.vacancy": "Neobsadenosť",
    "buyRent.costs": "Náklady z nájmu",
    "buyRent.rentalTax": "Daň z prenájmu",
    "buyRent.netRent": "Čistý nájom po neobsadenosti, nákladoch a dani",
    "buyRent.buyerLandlord": "Kúpa na prenájom",
    "buyRent.renterLandlord": "Investovanie inde",
    "buyRent.verdictBuyLandlord": "Kúpa na prenájom vychádza lepšie",
    "buyRent.verdictRentLandlord": "Investovanie inde vychádza lepšie",
    "buyRent.chartSubtitleLandlord":
      "Vlastný kapitál + investovaný prebytok nájmu vs. investovaná akontácia + mesačné doplatky",
    "buyRent.methodBodyLandlord":
      "Nájom od nájomníkov — znížený o neobsadenosť, náklady a daň — spláca hypotéku; čo chýba, doplácate z vlastného vrecka. Alternatíva investuje akontáciu a rovnaké mesačné doplatky pri zadanom výnose; po splatení hypotéky prenajímateľ investuje čistý nájom. Vlastné bývanie platíte v oboch scenároch rovnako, preto sa nezapočítava. Transakčné náklady a daň z investičných výnosov nie sú zahrnuté.",
    "buyRent.propertyPrice": "Cena nehnuteľnosti",
    "buyRent.propertyGrowth": "Rast ceny nehnuteľnosti",
    "buyRent.region": "Kraj",
    "buyRent.region.sk": "Slovensko (priemer)",
    "buyRent.region.ba": "Bratislavský",
    "buyRent.region.tt": "Trnavský",
    "buyRent.region.tn": "Trenčiansky",
    "buyRent.region.nr": "Nitriansky",
    "buyRent.region.za": "Žilinský",
    "buyRent.region.bb": "Banskobystrický",
    "buyRent.region.ke": "Košický",
    "buyRent.region.po": "Prešovský",
    "buyRent.region.custom": "Vlastné tempo",
    ...
    "buyRent.presetsLabel": "Porovnajte s historickými výnosmi:",
    "buyRent.preset.savings": "Sporenie",
    "buyRent.preset.gold": "Zlato",
    "buyRent.preset.sp500": "S&P 500",
    "buyRent.preset.btc": "Bitcoin",
    "buyRent.presetsDisclaimer":
      "Dlhodobé nominálne priemery: S&P 500 ~10 % p.a. (od 1928, s dividendami), zlato ~8 % p.a. (od 1971), bitcoin ~60 % p.a. (2016–2026), sporenie ~2 % (aktuálne sadzby na Slovensku). Na porovnanie: ceny bývania na Slovensku rástli v rokoch 2002–2025 v priemere ~7 % p.a. (NBS, podľa krajov ~6–8 %) — výber kraja predvyplní pole „Rast ceny nehnuteľnosti“. Toto obdobie zahŕňa aj boom 2005–2008; budúci rast môže byť nižší. Výnos sa aplikuje na peniaze, ktoré daná strana investuje — akontáciu a mesačný rozdiel v nákladoch na bývanie. Historické výnosy nezaručujú budúce; bitcoin je extrémne volatilný.",
    "buyRent.years": "rokov",
    "buyRent.year": "Rok",
    ...
    "buyRent.methodBody":
      "Oba scenáre minú každý mesiac rovnakú sumu — kto platí za bývanie menej, investuje rozdiel pri zadanom výnose. Majetok kupujúceho je hodnota nehnuteľnosti (rastúca zadaným tempom rastu cien) mínus zostávajúca hypotéka plus prípadné investície; nájomca na začiatku investuje akontáciu a nájom rastie s infláciou. Dane, údržba a transakčné náklady nie sú zahrnuté.",
  ...
  en: {
    ...
    "engine.metric4Value": "CZ + SK",
    "engine.metric4": "Markets covered",
    "engine.archLabel": "Estima Engine",
    ...
    "analyses.header.viewListing": "View listing",
    "analyses.header.sourceAd": "Original ad",
    "analyses.header.morePhotos": "+{n} photos",
    ...
    "analyses.pdf.section.buyVsRent": "Buy vs. rent & invest",
    "analyses.pdf.section.location": "Location amenities",
    "analyses.bvr.title": "Buy vs. rent & invest",
    "analyses.bvr.subtitle":
      "Model net-wealth projection over 30 years — the same section is part of the PDF report.",
    "analyses.bvr.localMarket": "local market",
    "analyses.bvr.assumptions":
      "Assumptions: rent {rent}/mo (rental-listing median, {district}) · mortgage 4% / 80% LTV / 30 yrs · price growth {growth}% p.a. (NBS, {region}, 2002–2025 average) · investment return 5% · inflation 2.5%. Model calculation, not financial advice.",
    ...
    "profile.subtitle": "Manage your details, password and subscription.",
    "profile.signInPrompt": "Sign in to view your profile.",
    "profile.planBasic": "Free",
    "profile.methodPassword": "E-mail & password",
    "profile.methodGoogle": "Linked with Google",
    "profile.manageBilling": "Manage subscription",
    "profile.upgrade": "Upgrade to Pro",
    "profile.adminReadOnly": "The admin account is managed through server configuration.",
    "profile.nameSection": "Display name",
    "profile.saveName": "Save",
    "profile.passwordSection": "Change password",
    "profile.passwordHint": "Enter your current password and a new one (min. 8 characters).",
    "profile.setPasswordSection": "Set a password",
    "profile.setPasswordHint": "Set a password so you can also sign in with e-mail.",
    "profile.currentPassword": "Current password",
    "profile.newPassword": "New password",
    "profile.changePassword": "Change password",
    "profile.setPassword": "Set password",
    "profile.saved": "Your changes were saved.",
    "profile.passwordSaved": "Your password was changed.",
    "profile.saveError": "Could not save. Please try again.",
    "profile.wrongPassword": "Your current password is incorrect.",
    "profile.weakPassword": "Password must be at least 8 characters.",
    ...
    "listings.priceMonthly": "Price (€/month)",
    "listings.priceChooseDeal": "Choose Sale or Rent to filter by price.",
    ...
    "property.onPortal": "Tracked",
    "property.day": "{n} day",
    "property.days": "{n} days",
    "property.marketPosition": "Market position",
    "property.comparedTo": "Compared to similar listings in {area}",
    "property.greatPrice": "Great price",
    "property.marketAverage": "Market average",
    "property.premium": "Premium",
    "property.save": "Save",
    "property.saved": "Saved",
    "property.share": "Share",
    "property.copied": "Link copied",
    "property.exportReport": "Export PDF report",
    "property.reportGenerating": "Generating…",
    "property.reportError": "Report unavailable — try again",
    "property.morePhotos": "More photos on original listing",
    "property.pricePerSqm": "Price per m²",
    "property.type": "Type",
    "property.layout": "Layout",
    "property.usableArea": "Usable area",
    "property.landArea": "Land area",
    "property.firstSeen": "First seen",
    ...
    "property.openInMaps": "Open in maps",
    "property.expandMap": "Expand map",
    "property.nearbyHint": "Expand the map to explore groceries, schools, transit and more nearby",
    "property.exploreNearby": "Explore nearby",
    "property.amenities": "Amenities",
    "property.groceries": "Groceries",
    "property.schools": "Schools & kindergartens",
    "property.transit": "Transit (public)",
    "property.restaurants": "Restaurants",
    "property.health": "Doctors, pharmacies",
    "property.leisure": "Leisure",
    "property.mapView": "Map",
    "property.satellite": "Satellite",
    "property.loadingPlaces": "Finding nearby places…",
    "property.placesError": "Couldn't load nearby places.",
    "property.noPlaces": "No places found within 1 km.",
    "property.retry": "Try again",
    "property.closeMap": "Close map",
    // Generic labels for unnamed OSM POIs, keyed by the tag value the map's
    // Overpass query can return (PropertyMap.tsx stores it as `Poi.type`).
    "poi.supermarket": "Supermarket",
    "poi.convenience": "Convenience store",
    "poi.greengrocer": "Greengrocer",
    ...
    "poi.food_court": "Food court",
    "poi.school": "School",
    "poi.kindergarten": "Kindergarten",
    "poi.university": "University",
    "poi.college": "College",
    "poi.pharmacy": "Pharmacy",
    "poi.doctors": "Doctor's office",
    "poi.clinic": "Clinic",
    ...
    "poi.theatre": "Theatre",
    "poi.park": "Park",
    "poi.fitness_centre": "Fitness centre",
    "poi.sports_centre": "Sports centre",
    "poi.playground": "Playground",
    "poi.pitch": "Sports pitch",
    "poi.swimming_pool": "Swimming pool",
    "poi.garden": "Garden",
    "poi.bus_stop": "Bus stop",
    "poi.tram_stop": "Tram stop",
    "poi.station": "Station",
    "poi.subway_entrance": "Subway entrance",
    "poi.halt": "Train halt",
    "poi.stop": "Stop",
    "property.interested": "Interested in this property?",
    "property.inquirySub": "Send a message and we'll connect you with the listing.",
    ...
    "property.dataSafe": "Your data is safe and will not be shared.",
    "property.inquirySent": "Inquiry sent",
    "property.inquirySentSub": "Thanks — we'll be in touch shortly.",
    "property.viewOriginal": "View original listing",
    "property.valuationTitle": "Want the market price?",
    "property.valuationSub":
      "Run this property through the Estima Engine for an instant valuation.",
    "property.runValuation": "Run valuation",
    "property.notFound": "Property not found",
    "property.notFoundSub": "This listing may have been removed or is no longer tracked.",
    ...
    "buyRent.mode.occupier": "Live in it",
    "buyRent.mode.landlord": "Rent it out",
    "buyRent.monthlyRentIncome": "Monthly rent (income)",
    "buyRent.vacancy": "Vacancy",
    "buyRent.costs": "Costs (of rent)",
    "buyRent.rentalTax": "Rental tax",
    "buyRent.netRent": "Net rent after vacancy, costs & tax",
    "buyRent.buyerLandlord": "Buy-to-let",
    "buyRent.renterLandlord": "Invest elsewhere",
    "buyRent.verdictBuyLandlord": "Buy-to-let comes out ahead",
    "buyRent.verdictRentLandlord": "Investing elsewhere comes out ahead",
    "buyRent.chartSubtitleLandlord":
      "Property equity + invested rent surplus vs. invested down payment + monthly top-ups",
    "buyRent.methodBodyLandlord":
      "Tenants' rent — reduced by vacancy, running costs and tax — pays the mortgage; whatever is missing, you top up out of pocket. The alternative invests the down payment and the same monthly top-ups at the given return; once the mortgage is paid off, the landlord invests the net rent. You pay for your own housing equally in both scenarios, so it cancels out. Transaction costs and tax on investment gains are not included.",
    "buyRent.propertyPrice": "Property price",
    "buyRent.propertyGrowth": "Property price growth",
    "buyRent.region": "Region",
    "buyRent.region.sk": "Slovakia (average)",
    "buyRent.region.ba": "Bratislava",
    "buyRent.region.tt": "Trnava",
    "buyRent.region.tn": "Trenčín",
    "buyRent.region.nr": "Nitra",
    "buyRent.region.za": "Žilina",
    "buyRent.region.bb": "Banská Bystrica",
    "buyRent.region.ke": "Košice",
    "buyRent.region.po": "Prešov",
    "buyRent.region.custom": "Custom rate",
    ...
    "buyRent.presetsLabel": "Compare with historical returns:",
    "buyRent.preset.savings": "Savings",
    "buyRent.preset.gold": "Gold",
    "buyRent.preset.sp500": "S&P 500",
    "buyRent.preset.btc": "Bitcoin",
    "buyRent.presetsDisclaimer":
      "Long-run nominal averages: S&P 500 ~10% p.a. (since 1928, dividends reinvested), gold ~8% p.a. (since 1971), bitcoin ~60% p.a. (2016–2026), savings ~2% (current Slovak deposit rates). For comparison: Slovak housing prices grew ~7% p.a. on average over 2002–2025 (NBS, ~6–8% by region) — picking a region pre-fills the \"Property price growth\" field. That window includes the 2005–2008 boom; future growth may be lower. The return applies to the money each side invests — the down payment and the monthly difference in housing costs. Past returns don't guarantee future ones; bitcoin is extremely volatile.",
    "buyRent.years": "yrs",
    "buyRent.year": "Year",
