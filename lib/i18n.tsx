...
const dict: Record<Lang, Record<string, string>> = {
  sk: {
    ...
    "analyses.pdf.desc.overview": "Prehľad nehnuteľnosti — typ, dispozícia, plocha, podlažie, stav a kľúčové parametre inzerátu.",
    "analyses.pdf.desc.valuation": "Odhadovaná trhová hodnota s cenovým rozpätím a porovnaním s ponukovou cenou.",
    "analyses.pdf.desc.market": "Kontext miestneho trhu — medián €/m², referenčné hodnoty a vývoj cenového indexu v lokalite.",
    "analyses.pdf.desc.comparables": "Podobné aktívne inzeráty zoradené podľa podobnosti, s €/m² a rozdielom ceny voči hodnotenej nehnuteľnosti.",
    "analyses.pdf.desc.location": "Občianska vybavenosť a mikrolokalita — doprava, školy, obchody a služby v okolí.",
    "analyses.pdf.desc.photo": "Ukazovatele kvality fotografií inzerátu — jas, ostrosť a celková prezentácia.",
    "analyses.pdf.desc.methodology": "Ako vznikol odhad — zdroje dát, výber porovnateľných inzerátov a upozornenie, že ide o dátový odhad, nie znalecký posudok.",
    "analyses.pdf.descToggle": "Zobraziť, čo sekcia obsahuje",
  ...
  en: {
    ...
    "analyses.pdf.desc.overview": "Property snapshot — type, layout, area, floor, condition and the listing's key attributes.",
    "analyses.pdf.desc.valuation": "Estimated market value with a price range, and how it compares to the asking price.",
    "analyses.pdf.desc.market": "Local market context — median €/m², benchmarks and the area's price-index development.",
    "analyses.pdf.desc.comparables": "Similar active listings ranked by similarity, with €/m² and price differences vs the subject property.",
    "analyses.pdf.desc.location": "Nearby amenities and micro-location — transport, schools, shops and services around the property.",
    "analyses.pdf.desc.photo": "Listing-photo quality signals — brightness, sharpness and overall presentation of the images.",
    "analyses.pdf.desc.methodology": "How the estimate was produced — data sources, comparable selection, and the note that this is a data-based estimate, not a certified appraisal.",
    "analyses.pdf.descToggle": "Show what this section includes",
